...
namespace Biblioteca.Controllers
{
    public class LibrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Título,Autor,Género,AñoPublicación")] Libro libro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Título,Autor,Género,AñoPublicación")] Libro libro)
        {
            if (id != libro.Id)
            {
                return NotFound();
